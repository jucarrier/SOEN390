...
public class CampusBuilder {
    ...
    public Campus buildLoyola() {
        Building ad = new Building(mMap, "Administration building", "Refectory, Montreal, QC H4B",
        ...
        Building cc = new Building(mMap, "Central Building", "7141 Rue Sherbrooke O, Montréal, QC H4B 2B5 Sherbrooke St W, Montreal, Quebec H4B 2B5",
        ...
        Building rf = new Building(mMap, "Jesuit hall and conference centre", "7141 Sherbrooke St W, Montreal, Quebec H4B 1R6",
        ...
        Building py = new Building(mMap, "Psychology Building", "Refectory, Montreal, Quebec H4B 2Z3",
        ...
        Building fc = new Building(mMap, "F.C. Smith building", "7141 Sherbrooke St W, Montreal, Quebec H4B 1R6",
        ...
        Building sp = new Building(mMap, "Richard J. Renaud Science Complex", "3475 Rue West Broadway Montreal, QC H4B 2A7",
        ...
        Building cj = new Building(mMap, "Communication studies and Journalism building", "7141 Sherbrooke St W, Montreal, Quebec H4B 1R6",
        ...
        Building vl = new Building(mMap, "Vanier Library", "7141 Sherbrooke St W, Montreal, Quebec H4B 1R6",
        ...
        Building ra = new Building(mMap, "Sports Complex", "7200 Sherbrooke St W, Montreal, Quebec H4B 1R2",
        ...
        Building ge = new Building(mMap, "Centre for structural and functional Genomics", "7079 Rue de Terrebonne, Montréal, QC H4B 2B4 Rue de Terrebonne, Montréal, QC H4B 2B4, Canada",
        ...
        Building cs = new Building(mMap, "Concordia Stadium", "7141 Sherbrooke St W, Montreal, Quebec H4B 1R2",
        ...
        Building sd = new Building(mMap, "Stinger Dome", "7200 Sherbrooke St W, Montreal, Quebec H4B 1R2",
